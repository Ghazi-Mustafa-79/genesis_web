...
//   return (
//     <section className="py-30 px-6 bg-[#f8f5db] min-h-screen">
...
//             whileTap={{ scale: 0.98 }}
//             className="flex items-center justify-between w-full bg-white shadow-lg rounded-2xl px-6 py-5 border border-green-100 hover:border-green-500 hover:shadow-green-200 transition-all"
//           >
//             <div className="flex items-center space-x-4">
