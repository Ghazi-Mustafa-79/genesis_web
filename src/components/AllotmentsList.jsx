...
import { FileText, Globe, Users, BookOpen } from "lucide-react";
...
const AllotmentsList = () => {
  const links = [
    ...
    },
    {
      ...
      url: "https://drive.google.com/file/d/1cSprQU9YRkOh6bjbTPy7-ddq_eGgMPPu/view?usp=sharing",
      external: true,
    },
    {
      label: "ECOSOC",
      icon: <BookOpen size={28} />, // 📖 Economic & Social Council (research, reports)
      url: "https://drive.google.com/file/d/13Dv6HqOp13_u66QguOwXBfjnL9odqdvQ/view?usp=sharing",
      external: true,
    },
  ];
