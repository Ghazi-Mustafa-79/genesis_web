            ...
            {formData.paymentMethod && (
              <div className="md:col-span-2 bg-green-50 border border-green-300 rounded-lg p-3 text-center">
                {formData.paymentMethod === "JazzCash" && (
                  <p>
                    Send payment to <strong>03097506051</strong> (JazzCash)
                  </p>
                )}
                {formData.paymentMethod === "SadaPay" && (
                  <p>
                    Send payment to <strong>03097506051</strong> (SadaPay)
                  </p>
                )}
                {formData.paymentMethod === "EasyPaisa" && (
                  <p>
                    Send payment to <strong>03709963350</strong> (EasyPaisa)
                  </p>
                )}
              </div>
            )}
